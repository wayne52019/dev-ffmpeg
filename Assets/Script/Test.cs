...
public class Test : MonoBehaviour
{
    ...
    public void getCallBack(string path)
    {
...
#endif
            cmd = "-i " + path + " " + OutputPath; // put your ffmpeg command here
        }
        //如果是影片
        ...
        AndroidJavaObject session = javaClass.CallStatic<AndroidJavaObject>("execute", new object[] { cmd });
        print("cmd:" + cmd);
